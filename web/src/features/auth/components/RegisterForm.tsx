  ...
  return (
    <div className="auth-card">
      ...
      <div className="auth-card-header">
        ...
        <p className="auth-card-subtitle">Completa tus datos para registrarte en la plataforma</p>
      </div>
      ...
      <div className="auth-card-form">
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-group">
            ...
            />
            <span className="helper-text">La contraseña debe tener al menos 8 caracteres</span>
          </div>
          ...
          <div className="form-group">
            ...
            />
            {!passwordsMatch && (
              <span className="helper-text helper-text-error">Las contraseñas no coinciden</span>
            )}
          </div>
