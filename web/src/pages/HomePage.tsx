  ...
  return (
    <div className="home-page">
      ...
      <header className="home-header">
        <img src="/assets/logo-horizontal.png" alt="WeGo" className="home-header-logo" />
        ...
        <div className="home-hero-content">
          <div className="home-hero-text">
            ...
            <p className="home-hero-description">
              Gestiona viajes, conductores, comisiones y reportes desde una sola plataforma. Control
              total sobre el negocio de transporte especializado.
            </p>
          </div>
          ...
          <div className="home-hero-features">
            ...
            <div className="home-hero-feature">
              ...
              <p className="home-hero-feature-description">Conductores verificados y seguros</p>
            </div>
          </div>
        </div>
      </section>
